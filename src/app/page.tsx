    ...
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:p-x-0 lg:pt-4">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  the design. Had the case for 5 months and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>
                  , on the case I had before, the image started fading into
                  yellow-ish color after couple weeks. Love it.&quot;
                </p>
              </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"></Check>
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"></Check>5
              years print
            </li>
            <div className="flex justify-center">
              ...
              >
                ...
                <ArrowRight className="h-4 w-4 ml-1.5"></ArrowRight>
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
